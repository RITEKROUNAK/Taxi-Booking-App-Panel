...
<div class="d-flex justify-content-end align-items-center">
    ...
    @if($auth_user->can('complaint show'))       
        <a class="mr-2" href="{{ route('complaint.show', $id) }}" title="{{ __('message.view_form_title',['form' => __('message.complaint') ]) }}"><i class="fas fa-eye text-secondary"></i></a>
    @endif
