        ...
        if (response.statusCode == 200) {
          ...
          await Stripe.instance.initPaymentSheet(
            paymentSheetParameters: SetupPaymentSheetParameters(
              ...
              merchantDisplayName: 'Taxi Rider',
  ...
  void mercadoPagoPayment() async {
    var body = json.encode({
      "items": [
        {
          "title": "Taxi Rider",
          "description": "Taxi Rider",
          "quantity": 1,
          "currency_id": appStore.currencyName.toUpperCase(),
    ...
    try {
      final response = await http.post(
        Uri.parse(
            'https://api.mercadopago.com/checkout/preferences?access_token=${mercadoPagoAccessToken.toString()}'),
        body: body,
