...
class RegisterScreen extends StatefulWidget {
  ...
  RegisterScreen({this.socialLogin = false, this.userName, this.isOtp = false, this.countryCode, this.privacyPolicyUrl, this.termsConditionUrl});
                ...
                children: [
                  ...
                  DropdownButtonFormField(
                    ...
                    items: gender
                        ...
                        value: value, child: Text("${value.capitalizeFirstLetter()}",style: primaryTextStyle(),)))
                        .toList(),
                  ),
                  SizedBox(height: 16),
                  Row(
