                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text('${language.lblRide} #${data.id}', style: boldTextStyle(size: 14)),
                                    ],
                                  ),
                                  ...
                                  //   crossAxisAlignment: CrossAxisAlignment.start,
                                  //   children: [
                                  //     Icon(Icons.near_me,size: 20, color: Colors.green),
                                  //     SizedBox(width: 10),
                                  //     Expanded(
                                  //       child: Column(
                                  //         crossAxisAlignment: CrossAxisAlignment.start,
                                  //         mainAxisAlignment: MainAxisAlignment.start,
                                  //         children: [
                                  //           // Text(printDate(data.datetime!), style: secondaryTextStyle(size: 12)),
                                  //           // SizedBox(height: 4),
                                  //           Text(data.startAddress.validate(), style: primaryTextStyle(size: 14)),
                                  //         ],
                                  //       ),
                                  //     ),
                                  //   ],
                                  ...
                                  //   mainAxisAlignment: MainAxisAlignment.start,
                                  //   children: [
                                  //     Icon(Ionicons.location_sharp, size: 20, color: Colors.red),
                                  //     SizedBox(width: 10),
                                  //     Expanded(
                                  //       child: Column(
                                  //         crossAxisAlignment: CrossAxisAlignment.start,
                                  //         children: [
                                  //           // if (data.endTime != null) Text(data.endTime != null ? printDate(data.endTime!) : '', style: secondaryTextStyle(size: 12)),
                                  //           // if (data.endTime != null) SizedBox(height: 4),
                                  //           Text(data.endAddress.validate(), style: primaryTextStyle(size: 14)),
                                  //         ],
                                  //       ),
                                  //     )
                                  //   ],
